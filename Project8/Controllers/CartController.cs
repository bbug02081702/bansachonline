...
#pragma warning disable CS0253 // Possible unintended reference comparison; right hand side needs cast
                var result = db.KhachHangs.SingleOrDefault(predicate: x => x.TaiKhoan == model);
#pragma warning restore CS0253 // Possible unintended reference comparison; right hand side needs cast
        ...
        protected string ThanhToanMoMo(string maDonHang,string tongCong)
        {
            ...
            string returnUrl = "http://sachonline.somee.com//Cart/Success";
            string notifyurl = "http://sachonline.somee.com/";
