...
namespace WebBanSach.Controllers
{
    public class UserController : Controller
    {
        ...
        public void BuildUserTemplate(int khMaKh)
        {
            ...
            var url = "http://sachonline.somee.com/" + "User/XacNhan?khMaKh="+khMaKh;
        ...
        public static void SendEmail(MailMessage mail)
        {
            ...
            client.Credentials = new System.Net.NetworkCredential("yuntips1702@gmail.com","sachonline");
            try
            {
                client.Send(mail);
            }
